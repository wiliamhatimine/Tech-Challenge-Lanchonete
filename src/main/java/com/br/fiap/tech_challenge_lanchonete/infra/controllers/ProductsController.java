...
public class ProductsController {
	...
	public ResponseEntity<List<Product>> getByCategorie(@PathVariable("categorie") String categorie){
		List<Product> listProducts = productsService.productByCategorie(categorie.toUpperCase());
	...
	public ResponseEntity<Product> createProduct(@RequestBody Product product){
		...
		try {
			productDetail = productsService.save(product);
		}catch(Exception e) {
	...
	public ResponseEntity<Product> editProduct(@RequestBody Product product){
		...
		try {
			productResponse = productsService.edit(product);
		}catch(Exception e) {
			logger.error("Erro ao cadastrar");
			throw e;
		}
